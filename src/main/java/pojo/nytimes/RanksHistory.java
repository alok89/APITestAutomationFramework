...
public class RanksHistory {
	...
	public String toString() {
		return "RanksHistory [primary_isbn10=" + primary_isbn10 + ", primary_isbn13=" + primary_isbn13 + ", rank="
				+ rank + ", list_name=" + list_name + ", display_name=" + display_name + ", published_date="
				+ published_date + ", bestsellers_date=" + bestsellers_date + ", weeks_on_list=" + weeks_on_list
				+ ", ranks_last_week=" + ranks_last_week + ", asterisk=" + asterisk + ", dagger=" + dagger + "]";
	}
